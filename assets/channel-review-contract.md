...
| sample | {requested_posts, substantive_posts, oldest, newest, retrieved_at, method, truncated}; отсутствующие даты null, method например telegram-user/browser/provided-export/none |
